...
namespace StudentDeptWebAPI
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<StudentDeptContext>(options =>
            {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "StudentDeptWebAPI", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "StudentDeptWebAPI v1"));
            }
